    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            if (data.threadId && !threadId) {
                ...
                localStorage.setItem(`chat_thread_${user.uid}`, JSON.stringify({
            ...
            <div>
                <div className="flex flex-col items-start justify-center pl-20 min-h-screen">
                    ...
                    <header className="w-full">
                        ...
                        <div className="flex justify-between items-center">
                            <p className="text-2xl tracking-[-0.08em] flex-1">
                                The modern way to invest, providing unique insights on your personalized portfolio. Ask
                                me a question!
                            </p>
                        </div>
                    </header>
                    ...
                    <div className={`${kaisei.className} w-full tracking-[-0.08em]`}>
                        <div className="mt-6 h-[400px] overflow-y-auto border border-gray-200 rounded-lg">
                            {showWelcomeScreen ? (
                                <div className="flex flex-col items-center justify-center h-full">
                                    <p className="text-xl mb-4">Welcome to your personal investment agent</p>
                                    <p className="text-gray-600 mb-8">Ask me about your portfolio performance,
                                        investment strategies, or market trends.</p>
                                </div>
                            ) : (
                                        ...
                                        <div className="flex justify-start">
                                            <div className="bg-gray-100 p-3 rounded-lg rounded-tl-none">
                                                <div className="flex space-x-2">
                                                    <div
                                                        className="w-2 h-2 bg-gray-400 rounded-full animate-pulse"></div>
                                                    <div
                                                        className="w-2 h-2 bg-gray-400 rounded-full animate-pulse delay-75"></div>
                                                    <div
                                                        className="w-2 h-2 bg-gray-400 rounded-full animate-pulse delay-150"></div>
                                                </div>
                                            </div>
                                        </div>
                                    )}
